        ...
        setContent {
            PizzeriaTheme {
                Surface(
                    ...
                    dbPending.whereEqualTo("Status", "Processing").get().addOnSuccessListener { queryDocumentSnapshot ->
...
@Composable
fun PendingScreen(context: Context, pendingList: List<OrderData>) {
    Column(
        modifier = Modifier
            .fillMaxSize(),
    ) {
                ...
                Surface(
                    ...
                    Row(
                        ...
                        Column(modifier = Modifier.padding(end = 15.dp)) {
                            IconButton(onClick = {
                                updateOrderStatus(order.OrderID ?: "", OrderStatus.Shipping)
